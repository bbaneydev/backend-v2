...
export default function Home({ cars, currentUser, handleAddFavorite, handleAddWishlist }) {
    ...
    return (
        <div className='home'>
            ...
            <Cards cars={cars} handleAddFavorite={handleAddFavorite} handleAddWishlist={handleAddWishlist} />
        </div>
    )
}